...
root_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # For parent directory
# OR if resources are in same directory as Main.py:
...
# Temporary debug code at the top
print("Current working directory:", os.getcwd())
print("Python path:", sys.path)
print("App module exists:", os.path.exists(os.path.join(sys.path[0], 'app', 'config.py')))
print(f"Project root: {project_root}")
print(f"App config exists: {os.path.exists(os.path.join(project_root, 'app', 'config.py'))}")
...
def main():
    ...
    font_dir = os.path.join(root_dir, "webui", "resource", "fonts")
        ...
        with st.expander(tr("Basic Settings"), expanded=False):
            ...
            with middle_config_panel:
                ...
                if llm_provider == "deepseek":
                    ...
                    with llm_helper:
                        tips = """
                               ...
                               - **API Key**: [Get from official platform](https://platform.deepseek.com/api_keys)
                               - **Base Url**: Fixed to https://api.deepseek.com
                               - **Model Name**: Use deepseek-chat
                               """

                if llm_provider == "ernie":
                    with llm_helper:
                        tips = """
                               ##### 百度文心一言 Configuration
                ...
                if tips and config.ui["language"] == "zh":
                    st.warning(
                        "Recommended providers for better connectivity:\n- DeepSeek\n- Moonshot\n- Cloudflare AI"
                    )
                    st.info(tips)
